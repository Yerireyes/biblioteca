                 ...
                 <div class="card-body"> {{--todo el formulario de registro --}}
                    ...
                    <form method="POST" action="/myreg">
                        ...
                        <div class="form-group row">
                            ...
                            <!-- <div class="col-md-6">
                                <input hidden id="profilePicture" type="text" class="form-control @error('profilePicture') is-invalid @enderror" name="profilePicture" value="abc" required autocomplete="profilePicture" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <!-- <div class="col-md-6">
                                <input hidden id="roleid" type="text" class="form-control @error('roleid') is-invalid @enderror" name="roleid" value="1" required autocomplete="roleid">
